...
const PaymentHistory = () => {
    ...
    // Render modal for viewing/downloading selected receipt
    return (
        <>
            {/* existing markup returned above is already rendered; include modal here */}
            <ReceiptModal open={receiptOpen} setOpen={setReceiptOpen} payment={selectedPayment} isWorker={isWorker} />
        </>
    )
}

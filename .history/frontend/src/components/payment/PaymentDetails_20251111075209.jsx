                ...
                <div className="bg-white rounded-lg shadow-lg border overflow-hidden">
                    ...
                    <div className="bg-gray-50 p-6 border-t flex justify-center">
                                                                <div className='flex gap-3'>
                                                                        ...
                                                                        <Button onClick={() => setReceiptOpen(true)} className="bg-slate-50 text-slate-700 border border-slate-200">View / Download PDF</Button>
                                                                </div>
                    </div>
                </div>
            </div>
                                                        <ReceiptModal open={receiptOpen} setOpen={setReceiptOpen} payment={payment} isWorker={isWorker} />
        </div>
    )
}

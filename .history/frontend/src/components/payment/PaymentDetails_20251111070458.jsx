            ...
            <div className="max-w-4xl mx-auto my-10 px-4">
                ...
                <head>
                    ...
                    <style>
                        ...
                        .container{max-width:720px;margin:24px auto;padding:20px;border:1px solid #e5e7eb;border-radius:8px}
                        .header{background:linear-gradient(90deg,#6366f1,#a78bfa);color:white;padding:18px;border-radius:6px}
                        .title{font-size:20px;margin:0}
                        .muted{color:#6b7280}
                        .grid{display:grid;grid-template-columns:1fr 1fr;gap:12px;margin-top:16px}
                        .card{background:#f9fafb;padding:12px;border-radius:6px}

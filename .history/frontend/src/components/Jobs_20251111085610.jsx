            ...
            <div className='max-w-7xl mx-auto mt-5 px-4'>
                <div className='flex gap-5 flex-col md:flex-row'>
                    <div className='w-full md:w-1/4'>
                        <div className="mb-4">
                            {!showMap ? (
                                <div className="p-3 rounded border border-dashed border-gray-200 bg-white">
                                    <div className="mb-3">
                                        <div className="w-full h-40 bg-gray-200 rounded-md overflow-hidden animate-pulse" aria-hidden="true"></div>
                                    </div>
                                    ...
                                    <div className="flex gap-2">
                                        <button
                                            ...
                                            className="px-3 py-2 bg-blue-600 text-white rounded text-sm hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-400"
                                        >
                                            Open map tools
                                        </button>
                                        <button
                                ...
                                <Suspense fallback={
                                    <div className="p-3 rounded bg-white border border-gray-100">
                                        <div className="w-full h-48 bg-gray-200 rounded-md mb-3 animate-pulse" aria-hidden="true"></div>
